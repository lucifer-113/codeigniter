		...
		<div class="row" id="footer">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<address>
					  <strong>    SHOP thời trang Fashion</strong><br>
					  <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Địa chỉ: 1120 Nguyễn Tất Thành-Thị xã Hương Thủy , Huế	<br>
					  <span class="glyphicon glyphicon-phone" aria-hidden="true"></span> Điện thoại: 0366179912<br>
					  Copyright ©2020 - Design by Thuanvo
					</address>
				</div>
